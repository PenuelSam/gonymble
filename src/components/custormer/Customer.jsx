...
const Customer = () => {
  return (
    <div className='w-[600px] md:w-[100vw] md:h-[60%] z-[200] lg:h-[600px] xsm:pl-[30px] h-[500px]  bg-black/70'>
       ...
       <form className='flex flex-col justify-center items-center  h-full '>
        ...
        <div className='flex items-center md:flex-col md:items-start justify-between gap-[20px] py-[10px]  mr-[15%]'>
          <label className='font-normal text-slate-200 lg:text-[25px] md:text-[20px]'>Message:</label>
          <textarea cols="20" placeholder='Message' className='bg-transparent  text-white border py-[5px] px-[5px] outline-none overflow-hidden'></textarea>
        </div>
        <button className='btn-theme bgc m-[20px] md:ml-0 ml-[10%] text-white lg:text-[25px] md:text-[15px]'>Message</button>
       </form>
    </div>
  )
}
