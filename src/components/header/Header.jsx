    ...
    <div className='header'>
      <div className="container flex relative top-[30%] lg:top-[40%]  justify-between items-center">
            ...
            <div className='mt-[15px] flex items-center ml-0 lg:ml-[15px] md:ml-[8px]'>
              <input type="text" placeholder='Track your package' className='p-[5px] px-[10px] outline-none border-none lg:p-[10px] lg:px-[15px] md:p-[5px] md:px-0 md:pl-1 xsm:px-[5px]  text-[18px] lg:text-[30px] md:text-[15px]  input' />
